...
struct ast_expr * ast_expr_new_binary(enum ast_expr_binary_op op, struct ast_expr * lhs, struct ast_expr * rhs) {
...
struct ast_expr * ast_expr_new_unary(enum ast_expr_unary_op op, struct ast_expr * expr) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr * ast_expr_new_braces(struct ast_expr * expr) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr * ast_expr_new_call(struct ast_expr * function, struct ast_expr_list arguments) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr * ast_expr_new_indexer(struct ast_expr * value, struct ast_expr_list indices) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr * ast_expr_new_place(char * id) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr * ast_expr_new_literal(struct ast_literal * literal) {
    struct ast_expr * result = malloc(sizeof(struct ast_expr));
...
struct ast_expr_list ast_expr_list_init(void) {
    return (struct ast_expr_list) {
        .size = 0,
        .capacity = 1,
        .values = malloc(sizeof(struct ast_expr *)),
    };
}
...
void ast_expr_list_append(struct ast_expr_list * list, struct ast_expr * value) {
    if (list->size >= list->capacity) {
        ...
        struct ast_expr ** const new_values = realloc(list->values, sizeof(struct ast_expr *) * new_capacity);
