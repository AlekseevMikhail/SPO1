...
struct ast_stmt_var_id ast_stmt_var_id_init(char * id, struct ast_expr * value) {
...
struct ast_stmt_var_id_list ast_stmt_var_id_list_init(void) {
    return (struct ast_stmt_var_id_list) {
        .size = 0,
        .capacity = 1,
        .values = malloc(sizeof(struct ast_stmt_var_id)),
    };
}
...
void ast_stmt_var_id_list_append(struct ast_stmt_var_id_list * list, struct ast_stmt_var_id value) {
    if (list->size >= list->capacity) {
        ...
        struct ast_stmt_var_id * const new_values =
                realloc(list->values, sizeof(struct ast_stmt_var_id) * new_capacity);
...
struct ast_stmt * ast_stmt_new_var(struct ast_type_reference * type, struct ast_stmt_var_id_list ids) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt * ast_stmt_new_block(struct ast_stmt_list stmts) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt * ast_stmt_new_while(struct ast_expr * condition, struct ast_stmt * body) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt * ast_stmt_new_do(struct ast_stmt * body, struct ast_expr * condition) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt * ast_stmt_new_break(void) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt * ast_stmt_new_expr(struct ast_expr * expr) {
    struct ast_stmt * result = malloc(sizeof(struct ast_stmt));
...
struct ast_stmt_list ast_stmt_list_init(void) {
    return (struct ast_stmt_list) {
        .size = 0,
        .capacity = 1,
        .values = malloc(sizeof(struct ast_stmt *)),
    };
}
...
void ast_stmt_list_append(struct ast_stmt_list * list, struct ast_stmt * value) {
    if (list->size >= list->capacity) {
        const size_t new_capacity = list->capacity * 2;
        struct ast_stmt ** const new_values = realloc(list->values, sizeof(struct ast_stmt *) * new_capacity);
